...
def do_deploy(archive_path):
    ...
    try:
        if os.path.exists(archive_path):
            ...
            run(f"sudo rsync -a --exclude='images' {uncompress_fold}/web_static/* {uncompress_fold}")
            run(f"sudo rsync -a --exclude='styles' {uncompress_fold}/web_static/* {uncompress_fold}")
